...
// slice(시작 인덱스, 끝 인덱스) => 끝 인덱스는 복사 범위에 포함 x
//  => 끝 인덱스 -1번째까지만 복사
let dogArr = ["coco", "happy", "choco", "navi"];
...
// 문제 fruits에 "banana"와 "orange" 사이에 "grape", "peach" 추가
